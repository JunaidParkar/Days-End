    ...
    return (
        <>
            <div className="flexCenter authContainer">
                <form method="post" className='flex' onSubmit={e => resetPasswordmail(e)} >
                    <h3>Reset your password</h3>
                    <input type="text" name="email" placeholder='Enter your E-Mail' onChange={(e) => setPasswordResetData({...passwordResetData, ['email']: e.target.value})} required />
