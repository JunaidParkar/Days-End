...
const createAuthToken = async (dataInJson) => {
    ...
    let jsonWebToken = jwt.sign(dataInJson, process.env.SECRET_KEY_TOKEN, { expiresIn: '12h' });
...
const generateUniqueId = () => {
    ...
    const randomDigits = Math.floor(Math.random() * 100000000000000000).toString().padStart(18, '0');
